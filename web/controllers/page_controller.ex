defmodule ElixirLetters.PageController do
  ...
  def index(conn, _params) do
    ...
    letters = %{ "E" => 12, "T" => 9, "A" => 8, "O" => 8, "I" => 7, "N" => 7, "S" => 6, "R" => 6, "H" => 5, "L" => 4, "D" => 3, "C" => 3, "U" => 2, "M" => 2, "F" => 2, "P" => 2, "G" => 1, "W" => 1, "Y" => 1, "B" => 1, "V" => 1, "K" => 1, "X" => 1, "J" => 1, "Q" => 1, "Z" => 1, "e" => 12, "t" => 9, "a" => 8, "o" => 7, "i" => 7, "n" => 7, "s" => 6, "r" => 6, "h" => 5, "l" => 4, "d" => 3, "c" => 3, "u" => 2, "m" => 2, "f" => 2, "p" => 2, "g" => 2, "w" => 2, "y" => 2, "b" => 1, "v" => 9, "k" => 6, "x" => 1, "j" => 1, "q" => 1, "z" => 1, "!" => 5, "?" => 5 }
